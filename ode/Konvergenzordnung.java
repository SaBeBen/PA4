package ode;
import planeten.Planetensystem;
...
public class Konvergenzordnung {
    ...
    {
        double h1 = Math.random();
        double h2 = h1/2;
        double e1 = error(verfahren.nextStep(y0, T, h, testODE));
        double e2 = error(verfahren.nextStep(y0, T, h/2, testODE));
